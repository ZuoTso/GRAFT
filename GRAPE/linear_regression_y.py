...
def main():
    ...
    parser.add_argument('--node_mode', type=int, default=0)       # 與 all 腳本一致
    parser.add_argument('--split_by',  type=str, default='y')     # 與 all 腳本一致
    parser.add_argument('--split_sample', type=float, default=0.0)
    parser.add_argument('--level', type=int, default=0)   # ← 新增這行
